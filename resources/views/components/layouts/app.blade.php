...
<body class="min-h-screen bg-[#fafafb] text-[#030229] antialiased">
    ...
    <nav class="fixed inset-x-0 bottom-0 z-50 grid {{ auth()->user()->role->value === 'admin' ? 'grid-cols-4' : 'grid-cols-3' }} border-t border-[#030229]/5 bg-white/95 px-2 pb-[max(.5rem,env(safe-area-inset-bottom))] pt-2 shadow-[0_-8px_30px_rgba(3,2,41,.08)] backdrop-blur lg:hidden">
